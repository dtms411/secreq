...
const LINKS: { href: string; label: string; icon: ReactNode }[] = [
  { href: '/', label: 'Tie-out', icon: I(<><rect x="2" y="2" width="5" height="5" rx="1" /><rect x="9" y="2" width="5" height="5" rx="1" /><rect x="2" y="9" width="5" height="5" rx="1" /><rect x="9" y="9" width="5" height="5" rx="1" /></>) },
